(function () {
  ...
  const el = {
    ...
    openGame: document.getElementById("open-cafe-focus"),
    app: document.getElementById("cafe-focus"),
  ...
  function registerModule() {
    ...
    window.FocusQuizCafeFocus = moduleInfo;
  }
  ...
  function saveResult(result) {
    ...
    const cafeOnly = readJson("cafeFocusResults", []);
    cafeOnly.push(result);
    localStorage.setItem("cafeFocusResults", JSON.stringify(cafeOnly));
  }
