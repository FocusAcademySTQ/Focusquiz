/* =======================================================
   ...
   Arxiu: lang-cat.js
   Carrega'l després de main.js:
     <script src="main.js" defer></script>
     <script src="lang-cat.js" defer></script>
   Requereix que main.js tingui window.addModules(...)
   (Opcional) Si vols Config personalitzada, main.js ha de
   cridar pendingModule.config.render/collect (ja ho tens).
   ======================================================= */
...
(function(){
  ...
  const BANK_JG = [
    ...
    { text: `Escriu (g/j): genollar (a terra) — omet/afegeix si cal`, answer: `genollar` },
