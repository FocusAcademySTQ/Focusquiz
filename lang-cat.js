...
(function(){
  ...
  const BANK_BV = [
    ...
    { text: `Escriu correctament (B/V): __olca (recipient)`, answer: `volca` },
    { text: `Escriu correctament (B/V): __ell (recipient)`, answer: `vell` },
    { text: `Escriu correctament (B/V): sa__otar (saltar)`, answer: `sabotar` },
    ...
    { text: `Escriu correctament (B/V): __otar (votar)`, answer: `votar` },
    { text: `Escriu correctament (B/V): __enir (venir)`, answer: `venir` },
    { text: `Escriu correctament (B/V): __alència (valència)`, answer: `valència` },
