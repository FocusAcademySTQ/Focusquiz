-- Tip: When copying this script from GitHub, use the **Raw** view so that
-- diff markers like `@@` are not included. Those markers come from pull
-- request previews and Supabase will report a syntax error near `@@` if they
-- are pasted into the SQL editor.
